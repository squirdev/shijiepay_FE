...
import { useWeightsConfigDialog } from './composables/useWeightsConfigDialog'
...
const { crudSchemas } = useTableColumns({
  ...
  showConfigModal: openConfigDialog
})
  ...
  <div>
    ...
    <ContentWrap class="search-section">
      <Search
        ...
        :show-add="hasPermi('tunnleManageAdd')"
        @add="openDialog('add')"
    ...
    <WeightsConfig
      v-model="configVisble"
      :visible="configVisble"
      :row="configCurrentRow"
      :saveCallback="handleSaveConfig"
    />
  </div>
</template>
