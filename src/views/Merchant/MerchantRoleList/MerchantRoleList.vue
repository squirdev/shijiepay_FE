...
import { getRoleListApi, roleListApi } from '@/api/merchant'
...
const { tableRegister, tableState, tableMethods } = useTable({
  ...
  fetchDelApi: async () => {
    const res = await roleListApi({ action: 'del', data_uuid: ids.value[0] })
    return !!res.success
  }
})
        ...
        default: (data: any) => {
          ...
          return (
            <div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: center;">
              ...
              {hasPermi('mchRoleUpdatePermissions') && (
                <>
...
const addRole = async () => {
  ...
  if (formData) {
    ...
    try {
      ...
      const res = await roleListApi(newValues)
      if (res) {
        currentPage.value = 1
        getList()
    ...
    <ContentWrap class="search-section">
      <div class="log-search">
        ...
        <Search
          ...
          :show-add-role="hasPermi('mchRoleAdd')"
